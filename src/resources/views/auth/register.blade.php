<x-layout>
    <div class="bg-white rounded-lg shadow-md w-full md:max-w-xl mx-auto mt-12 p-8 py-12">
        ...
        <form action="{{ route('register.store') }}" method="POST">
            ...
            <button
                class="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded focus:outline-none">Register</button>
        </form>
        <p class="mt-4 text-gray-700">Already have an account? <a href="{{ route('login') }}"
                class="text-blue-900 hover:underline">Login here</a></p>
